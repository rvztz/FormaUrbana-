...
def get_treeegresos(year='2018',hist='a'):
    tregresos = px.treemap(df_ingeg.query('Year=='+year+' and Hist=="'+hist+'"').dropna(how='any', subset=['Monto_egresos']), path=['Municipio', 'Egresos'], values = 'Monto_egresos', color = 'Monto_egresos', color_continuous_scale='magma', template = 'plotly_dark',  height=600)
